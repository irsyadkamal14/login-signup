...
import 'camerasiswa.dart';
import 'detailsiswa.dart';
...
class _HomeState extends State<HomeSiswa> {
              ...
              IconButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const HomeSiswa()));
                  },
                  icon: Icon(
                    Icons.home,
              ...
              IconButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const camerasiswa()));
                  },
                  icon: Icon(
                    Icons.camera,
                    color: Color.fromARGB(255, 2, 16, 41),
